...
st.markdown("""
    ...
    /* Capa de fondo con tu imagen local fondo.jpeg */
    .stApp {
        background: url("fondo.jpeg") no-repeat center center fixed;
        background-size: cover;
    }

    /* Overlay oscuro con desenfoque para legibilidad */
    .stApp::before {
        content: "";
        position: fixed;
        top: 0;
        ...
        width: 100%;
        height: 100%;
        background: rgba(0, 26, 53, 0.85); /* Azul institucional profundo */
        backdrop-filter: blur(8px); /* Desenfoque de la ciudad */
        z-index: -1;
    }
    ...
    /* Slogan estilo Volkswagen Serial Black (Montserrat 900) */
    .baq-slogan {
        font-family: 'Montserrat', sans-serif;
        font-size: 1.8rem;
        font-weight: 900;
    ...
    /* Footer Institucional con información ficticia */
    .baq-footer {
...
def main():
    ...
    if df is not None:
        ...
        with st.sidebar:
            ...
            st.divider()
            st.caption("Actividad Académica 2024")
        ...
        st.markdown("""
            <div class="baq-footer">
                <div style="display: flex; flex-wrap: wrap; justify-content: space-around; gap: 30px; max-width: 1200px; margin: 0 auto;">
                    <div>
                        <h4 style="color:#DFFF9A;">CONTACTO OFICIAL (FICTICIO)</h4>
                        ...
                        <p style="font-size:0.9rem; color:#cbd5e0;"><i class="fas fa-envelope"></i> eventos.protocolo@edu-baq.gov.co</p>
                    </div>
                    <div>
                        <h4 style="color:#DFFF9A;">SÍGUENOS EN REDES</h4>
                        <div style="display:flex; flex-direction: column; gap:10px; font-size:1.1rem; color: #DFFF9A;">
                            <span><i class="fab fa-facebook"></i> @baq_digital_oficial</span>
                            <span><i class="fab fa-twitter"></i> @protocolo_baq_edu</span>
                            <span><i class="fab fa-instagram"></i> @baq_esta_de_moda_ficticio</span>
                        </div>
                    </div>
                </div>
                <p style="text-align:center; margin-top:3rem; opacity:0.4; font-size:0.8rem;">© 2024 Alcaldía de Barranquilla • Actividad Académica de Protocolo Digital • Información con fines educativos</p>
            </div>
        """, unsafe_allow_html=True)
